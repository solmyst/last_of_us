...
export default function SandSimulator() {
  ...
  return (
    <section id="sand" className="py-24 max-w-7xl mx-auto px-6 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="flex items-center gap-4 mb-4 relative">
            <span className="font-mono text-sm tracking-widest text-accent uppercase">06. EXPERIMENT</span>
            <div className="h-[1px] w-24 bg-border-subtle" />
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-text-primary uppercase tracking-tight mb-6">Built-in Sand Simulator</h2>
          <p className="text-text-secondary text-lg leading-relaxed mb-8">
            Interactive physics simulation built with Vanilla JS and Canvas. 
