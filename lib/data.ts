...
export const decisionsLog: Decision[] = [
  ...
  projects[0].decisions[1], // MemeForge: Next.js vs Vite
  {
    ...
    date: "Aug 2024",
    context: "product",
    statement: "Build vendor (tailor) dashboard first vs. customer UI first",
    optionA: {
      label: "Vendor dashboard first",
      why: "Supply is the harder constraint. No tailors onboarded = no product, regardless of customer UI quality.",
    },
    optionB: {
      label: "Customer UI first",
      why: "Customer experience is what you can demo and show investors. Easier to get early feedback.",
    },
    chose: "A",
    because:
      "Classic two-sided marketplace problem. The riskiest assumption is 'will tailors actually use this?' not 'will customers want custom clothes?' — demand for custom clothing is proven. If tailors won't adopt the workflow, the customer UI is irrelevant. Build supply first, validate the harder side.",
    wouldDoDifferently:
      "Should have done 5 vendor interviews before writing any code. I made assumptions about tailor workflows that turned out to be wrong (most don't work from a fixed price list).",
  },
];
...
export const personal = {
  ...
  email: "anushgupta105@gmail.com",                       // FILL IN
  ...
  resume: "/resume.pdf",                            // put PDF in /public/
